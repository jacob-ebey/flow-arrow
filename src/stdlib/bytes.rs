...
pub const INDEX_OF: StdSymbol = node(MODULE, "index_of", "(Bytes,Bytes)", "Int");
pub const LAST_INDEX_OF: StdSymbol = node(MODULE, "last_index_of", "(Bytes,Bytes)", "Int");
pub const BYTE_SLICE: StdSymbol = node(MODULE, "slice", "(Bytes,Int,Int)", "Bytes");
pub const TAKE: StdSymbol = node(MODULE, "take", "(Bytes,Int)", "Bytes");
pub const DROP: StdSymbol = node(MODULE, "drop", "(Bytes,Int)", "Bytes");
pub const REPLACE: StdSymbol = node(MODULE, "replace", "(Bytes,Bytes,Bytes)", "Bytes");
pub const REPEAT_BYTES: StdSymbol = node(MODULE, "repeat_bytes", "(Bytes,Int)", "Bytes");
