...
pub const FLAG_PRESENT: StdSymbol = node(MODULE, "flag_present", "(Args,Bytes)", "Bool");
pub const FLAG_VALUE: StdSymbol = node(MODULE, "flag_value", "(Args,Bytes)", "Faultable[Bytes]");
